(() => {
  ...
  surprisePinForm.addEventListener('submit',async e=>{
    ...
    if(entered!==SURPRISE_PIN){surprisePinError.textContent='Not quite… this little secret knows its name. ♥';surprisePinInput.value='';surprisePinInput.classList.remove('pin-wrong');void surprisePinInput.offsetWidth;surprisePinInput.classList.add('pin-wrong');return}
